...
const BlockchainPotentialSection = () => {
  return (
    <div className="max-w-6xl mx-auto flex flex-col xl:flex-row gap-5 items-center">
        ...
        <div className="flex flex-col gap-4 p-2 font-semibold text-center lgl:text-left max-w-[1000px]">
            <p className="text-base lgl:text-2xl">
                Join us on this exciting journey as we explore the vast expanse of blockchain potential. 
                Dive deeper into Atom Universe and discover how you can be part of this revolutionary movement.
            </p>
        </div>
    </div>
  )
