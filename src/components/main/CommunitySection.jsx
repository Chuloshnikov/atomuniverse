...
const CommunitySection = () => {
  const text1 = "AAtom Universe offers the speed, scalability and security you expect from cutting-edge blockchain technology. We believe in the power of community and the democratization of access to technology, so our blockchain is designed so that everyone can experience its benefits.";
  const text2 = "JJoin us on this exciting journey. Together, we can create a future that deserves the world's attention. Discover Atom Universe - your key to a new digital world!";
  return (
